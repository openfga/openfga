...
## [Unreleased]
### Added
- Log successful health checks at `Info` level instead of `Debug`. [#2827](https://github.com/openfga/openfga/pull/2827)
...
[Unreleased]: https://github.com/openfga/openfga/compare/v1.11.1...HEAD
