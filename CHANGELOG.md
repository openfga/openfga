...
- New metric `check_duration_ms` measuring the time it takes to resolve a check query at the command level. [#2139](https://github.com/openfga/openfga/pull/2139)
