...
- Improve Check API performance when experimental flag `enable-check-optimizations` is turned on and the model contains union of the following: TTU or userset, and algebraic operations. [#2200](https://github.com/openfga/openfga/pull/2200), [#2249](https://github.com/openfga/openfga/pull/2249)
