...
## [Unreleased]
### Fixed
- Downgrade `golang-jwt/jwt` to v5.2.2 as v5.2.3 introduced a breaking change that is not compatible with the current codebase. [#2634](https://github.com/openfga/openfga/pull/2609)
