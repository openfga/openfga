...
- Fixed goroutine leak in tests for Check API by making sure that dangling goroutines are waited on before stopping the server [#2247](https://github.com/openfga/openfga/pull/2247)
