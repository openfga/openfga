...
- Re-apply the caller's deadline to the detached query context in `sqlcommon.rowGetter.GetRows`, so a slow query can no longer outlive the request that started it. [#3109](https://github.com/openfga/openfga/pull/3109)
