...
// MockTupleEvaluator is a mock of TupleEvaluator interface.
type MockTupleEvaluator struct {
	ctrl     *gomock.Controller
	recorder *MockTupleEvaluatorMockRecorder
	isgomock struct{}
}

// MockTupleEvaluatorMockRecorder is the mock recorder for MockTupleEvaluator.
type MockTupleEvaluatorMockRecorder struct {
	mock *MockTupleEvaluator
}

// NewMockTupleEvaluator creates a new mock instance.
func NewMockTupleEvaluator(ctrl *gomock.Controller) *MockTupleEvaluator {
	mock := &MockTupleEvaluator{ctrl: ctrl}
	mock.recorder = &MockTupleEvaluatorMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockTupleEvaluator) EXPECT() *MockTupleEvaluatorMockRecorder {
	return m.recorder
}

// Read mocks base method.
func (m *MockTupleEvaluator) Read(ctx context.Context, store string, tupleKey *openfgav1.TupleKey, readOptions storage.ReadOptions, evalOptions ...storage.TupleOrderFunc) (storage.TupleIterator, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, store, tupleKey, readOptions}
	for _, a := range evalOptions {
...
// Read indicates an expected call of Read.
func (mr *MockTupleEvaluatorMockRecorder) Read(ctx, store, tupleKey, readOptions any, evalOptions ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, store, tupleKey, readOptions}, evalOptions...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Read", reflect.TypeOf((*MockTupleEvaluator)(nil).Read), varargs...)
}

// ReadStartingWithUser mocks base method.
func (m *MockTupleEvaluator) ReadStartingWithUser(ctx context.Context, store string, filter storage.ReadStartingWithUserFilter, options storage.ReadStartingWithUserOptions, evalOptions ...storage.TupleOrderFunc) (storage.TupleIterator, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, store, filter, options}
	for _, a := range evalOptions {
		varargs = append(varargs, a)
	}
...
// ReadStartingWithUser indicates an expected call of ReadStartingWithUser.
func (mr *MockTupleEvaluatorMockRecorder) ReadStartingWithUser(ctx, store, filter, options any, evalOptions ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, store, filter, options}, evalOptions...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReadStartingWithUser", reflect.TypeOf((*MockTupleEvaluator)(nil).ReadStartingWithUser), varargs...)
}

// ReadUserTuple mocks base method.
func (m *MockTupleEvaluator) ReadUserTuple(ctx context.Context, store string, tupleKey *openfgav1.TupleKey, options storage.ReadUserTupleOptions) (*openfgav1.Tuple, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ReadUserTuple", ctx, store, tupleKey, options)
	ret0, _ := ret[0].(*openfgav1.Tuple)
	ret1, _ := ret[1].(error)
...
// ReadUserTuple indicates an expected call of ReadUserTuple.
func (mr *MockTupleEvaluatorMockRecorder) ReadUserTuple(ctx, store, tupleKey, options any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReadUserTuple", reflect.TypeOf((*MockTupleEvaluator)(nil).ReadUserTuple), ctx, store, tupleKey, options)
}

// ReadUsersetTuples mocks base method.
func (m *MockTupleEvaluator) ReadUsersetTuples(ctx context.Context, store string, filter storage.ReadUsersetTuplesFilter, options storage.ReadUsersetTuplesOptions, evalOptions ...storage.TupleOrderFunc) (storage.TupleIterator, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, store, filter, options}
	for _, a := range evalOptions {
		varargs = append(varargs, a)
...
// ReadUsersetTuples indicates an expected call of ReadUsersetTuples.
func (mr *MockTupleEvaluatorMockRecorder) ReadUsersetTuples(ctx, store, filter, options any, evalOptions ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, store, filter, options}, evalOptions...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReadUsersetTuples", reflect.TypeOf((*MockTupleEvaluator)(nil).ReadUsersetTuples), varargs...)
}
