...
type Authenticator interface {
	...
	Authenticate(requestContext context.Context) (*authn.AuthClaims, error)
...
func (n NoopAuthenticator) Authenticate(requestContext context.Context) (*authn.AuthClaims, error) {
