...
//	"github.com/openfga/openfga/cmd/openfga/service"
...
//}
//
//func ensureServiceUp(t *testing.T, s *service.service, transportCredentials credentials.TransportCredentials, httpHealthCheck bool) {
//	t.Helper()
//
...
//	require.NoError(t, err)
//
//	service, err := service.BuildService(config, logger.NewNoopLogger())
...
//
//	_, err = service.BuildService(config, logger.NewNoopLogger())
...
//}
//
//func tryStreamingListObjects(t *testing.T, test authTest, service *service.service, retryClient *retryablehttp.Client, validToken string) {
//	// create a store
...
//}
//
//func tryGetStores(t *testing.T, test authTest, service *service.service, retryClient *retryablehttp.Client) {
...
//		}
//
//		_, err = service.BuildService(config, logger)
//		require.ErrorIs(t, err, service.ErrInvalidHTTPTLSConfig)
//	})
//
...
//
//		_, err = service.BuildService(config, logger)
//		require.ErrorIs(t, err, service.ErrInvalidGRPCTLSConfig)
//	})
//
