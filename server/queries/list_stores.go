...
func (q *ListStoresQuery) Execute(ctx context.Context, req *openfgav1pb.ListStoresRequest) (*openfgav1pb.ListStoresResponse, error) {
	...
	resp := &openfgav1pb.ListStoresResponse{
		Stores:            stores,
