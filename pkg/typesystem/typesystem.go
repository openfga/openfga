...
// GetAuthorizationModel returns the underlying AuthorizationModel which this TypeSystem was
// constructed from.
func (t *TypeSystem) GetAuthorizationModel() *openfgav1.AuthorizationModel {
	return t.model
}
