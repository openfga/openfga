...
func (m *SQLite) Read(ctx context.Context, store string, tupleKey *openfgav1.TupleKey, opts storage.ReadOptions) (storage.TupleIterator, error) {
...
func (m *SQLite) ReadPage(ctx context.Context, store string, tupleKey *openfgav1.TupleKey, opts storage.ReadPageOptions) ([]*openfgav1.Tuple, []byte, error) {
	ctx, span := tracer.Start(ctx, "sqlite.ReadPage")
	defer span.End()

	iter, err := m.read(ctx, store, tupleKey, &opts.Pagination)
	if err != nil {
		return nil, nil, err
	}
	defer iter.Stop()
...
func (m *SQLite) ReadUserTuple(ctx context.Context, store string, tupleKey *openfgav1.TupleKey, options storage.ReadUserTupleOptions) (*openfgav1.Tuple, error) {
...
func (m *SQLite) ReadUsersetTuples(ctx context.Context, store string, filter storage.ReadUsersetTuplesFilter, opts storage.ReadUsersetTuplesOptions) (storage.TupleIterator, error) {
...
func (m *SQLite) ReadStartingWithUser(ctx context.Context, store string, opts storage.ReadStartingWithUserFilter, _ storage.ReadStartingWithUserOptions) (storage.TupleIterator, error) {
...
func (m *SQLite) ReadAuthorizationModel(ctx context.Context, store string, id string) (*openfgav1.AuthorizationModel, error) {
	ctx, span := tracer.Start(ctx, "sqlite.ReadAuthorizationModel")
	defer span.End()

	return sqlcommon.ReadAuthorizationModel(ctx, m.dbInfo, store, id)
}

func (m *SQLite) ReadAuthorizationModels(ctx context.Context, store string, opts storage.ReadAuthorizationModelsOptions) ([]*openfgav1.AuthorizationModel, []byte, error) {
...
func (m *SQLite) ListStores(ctx context.Context, opts storage.ListStoresOptions) ([]*openfgav1.Store, []byte, error) {
...
func (m *SQLite) ReadChanges(ctx context.Context, store, objectTypeFilter string, opts storage.ReadChangesOptions, horizonOffset time.Duration) ([]*openfgav1.TupleChange, []byte, error) {
...
func (m *SQLite) Close() {
	...
	m.db.Close() //TODO(PTT) handle error
}
