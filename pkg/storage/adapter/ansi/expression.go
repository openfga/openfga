...
// bindNode is a bound parameter literal: it renders as the dialect's placeholder and
...
func litSQL(value any) string {
	...
	case bool,
		...
		return fmt.Sprint(v)
	default:
		panic(fmt.Sprintf("pkg/storage/adapter/ansi: unsupported Lit type %T; use Bind", value))
	}
}
