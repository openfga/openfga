...
// operandNode is the Operand tier: a node that can be projected, aliased, grouped on, and
// passed as a function/aggregate/CAST argument, but never compared. It backs select-only
// columns such as Tuple.ConditionContext.
...
// are taken pairwise and rendered comma-separated as "key, value" (the MySQL
// JSON_OBJECT / JSON_OBJECTAGG form).
