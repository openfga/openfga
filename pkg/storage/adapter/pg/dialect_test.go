...
// build renders a statement or query through the pg dialect, returning its SQL and bind
// arguments. It uses a render-only builder (nil pool), exercising the same dialect New
