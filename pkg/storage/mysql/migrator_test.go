...
func (m *MySQLMigrationProvider) testExecuteMigrations(ctx context.Context, provider Provider, config storage.MigrationConfig) error {
...
func TestMySQLMigrationProviderExecuteMigrations(t *testing.T) {
	provider := NewMySQLMigrationProvider()
	...
	t.Run("ExecuteMigrations_GetVersionError", func(t *testing.T) {
		...
		require.Error(t, err)
		require.Contains(t, err.Error(), "failed to get mysql db version")
	})
	...
	t.Run("ExecuteMigrations_UpAll_Error", func(t *testing.T) {
		...
		err := provider.testExecuteMigrations(context.Background(), mockProvider, config)
		require.Error(t, err)
		require.Contains(t, err.Error(), "failed to run mysql migrations")
	})
	...
	t.Run("ExecuteMigrations_UpTo_Error", func(t *testing.T) {
		...
		err := provider.testExecuteMigrations(context.Background(), mockProvider, config)
		require.Error(t, err)
		require.Contains(t, err.Error(), "failed to run mysql migrations up to")
	})
	...
	t.Run("ExecuteMigrations_DownTo_Error", func(t *testing.T) {
		...
		err := provider.testExecuteMigrations(context.Background(), mockProvider, config)
		require.Error(t, err)
		require.Contains(t, err.Error(), "failed to run mysql migrations down to")
	})
...
func TestMySQLMigrationProviderAdditionalErrorScenarios(t *testing.T) {
	provider := NewMySQLMigrationProvider()
